...
from omsr_routing import osrm_process, osrm_process_schools
...
def origins_to_schools(city, origins_sample, metric_crs=2056, coord_crs=4326):
    ...
    if city == "Bern":
        ...
        # schools
        schools_geo = gpd.read_file(f"data/gpkg/schulen_zürich.gpkg", layer="stzh.poi_volksschule_view")

        # school districts
        schools_dist = gpd.read_file(f"data/gpkg/schulkreise_zürich.gpkg", layer="stzh.adm_schulkreise_a")
