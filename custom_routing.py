...
st.subheader("How long does it take from my (potential) 10m^2, 1200 CHF flat to ETH Hönggerberg?")
...
# Check whether date is selected, otherwise use default value. Convert to string for consistency.
if date is None:
    st.warning("Please select a date. Defaulting to 2025-03-13.")
    date = "2025-03-13"
else:
