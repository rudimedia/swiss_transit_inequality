...
# read data, cache to allow fast-ish switching
@st.cache_data
...
# color mapping
cmap = LinearSegmentedColormap.from_list("green_blue_red",["#0B4D03", "#1BA308", "#0B81E3", "#085DA3", "#9608A3", "#A30808", "#850505"])
norm = Normalize(vmin=0.5, vmax=4.0)

# add color column, from dependent variable clipped at 0.5 and 4 for comparability
